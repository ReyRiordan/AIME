...
if st.session_state["stage"] == CHAT_SETUP:
    messages = [{"role": "User", "content": "Hi, what brings you in today?"},
                {"role": "AI", "content": "Hi, I'm John Smith. came to the hospital because I was experiencing a heaviness in my chest."}]
